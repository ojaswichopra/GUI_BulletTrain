...
step 1-> open the file name "train_voltage_profile_with_train_number_outage.m" .
step 2-> change the load file in  "load("sample_filename_outage.mat")" as  "load("FILE_NAME.mat")"
step 3 -> Run "train_voltage_profile_with_train_number_outage.m" 
...
step 1-> open the file name "Full_track_voltage_profile_instant_t_outage.m" .
step 2-> change the load file in  "load("sample_filename_outage.mat")" as  "load("FILE_NAME.mat")"
...
step 4 -> Run "Full_track_voltage_profile_instant_t_outage.m" to get the voltage magnitude plot of whole track during the investigated time instant.
...
step 1 -> open the file name "overall_MVA_TSS_calulation_outage.m".
step 2-> change the load file in  "load("sample_filename_outage.mat")" as  "load("FILE_NAME.mat")"
step 3 -> Run "overall_MVA_TSS_calulation_outage.m" to get the MVA of all TSS's.
