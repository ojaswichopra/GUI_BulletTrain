...
zm = mresistance + mreactance*1i;
w = 2 * pi * f; 
rad_C = contact_wire_diameter/(2*1000); 
rad_M1 = messenger_wire_diameter/(2*1000); 
rad_G = earth_wire_diameter/(2*1000); 
rad_F = feeder_wire_diameter/(2*1000);   
rad_R1 = rail_diameter/(2*1000);
