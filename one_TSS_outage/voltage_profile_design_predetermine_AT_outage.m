function voltage_profile_design_predetermine_AT_outage(Voltage_distance_matrix_whole,AT,TSS,N_TSS_O)
    ...
    % xlim([1, length(pre_det_Voltage_distance_matrix_whole)]); % Uncomment if x-axis limit is needed
    desired_filename = '../Plots_oTo/voltage_profile_design_predetermine_AT_outage.png';
