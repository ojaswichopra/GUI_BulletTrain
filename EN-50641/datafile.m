...
HS_train_A_F_data=load("train_timetable_HS_AF.txt");
...
HS_train_F_A_data=load("train_timetable_HS_FA.txt");
...
SUB_train_A_F_data=load("train_timetable_SUB_AF.txt");
...
FR_train_A_F_data=load("train_timetable_FR_AF.txt");
