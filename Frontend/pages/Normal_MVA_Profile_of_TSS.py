...
def main():
    ...
    if st.button("Show MVA profile of TSS"):
        ...
        oc.eval(f"TSS_MVA_profile({TSS_input_no}, s_apprant_power_MVA_mag)")
        image_path = '../Plots_normal/TSS_MVA_profile.png'
        ...
        with open(image_path, "rb") as file:
            btn = st.download_button(
                label="Download Plot",
                data=file,
                file_name="TSS_MVA_profile.png",  # Replace with the desired download filename
                mime="image/png"
            )
