...
oc = Oct2Py() 
oc.eval('cd("../OHE_temp/two_TSS_outage")') 
...
def main():
    ...
    st.markdown("<h1 class='title'>Two Adjacent TSS outage Condition - Up Track</h1>", unsafe_allow_html=True)
    ...
    oc.eval(f"OHE_temp_cal_up_track(Ic_line_mag_Td_up, Ir_line_mag_Td_up, If_line_mag_Td_up, Ic_line_mag_Md_up, Ir_line_mag_Md_up, If_line_mag_Md_up, y, N_TSS, d, N_TSS_O, j_a, j_b, j_c, j_d, rad_C, rad_R1, rad_F, Resistance_C, Resistance_R1, Resistance_F, {OHE_config.Q_s}, {OHE_config.T_a}, {OHE_config.V_w}, {OHE_config.theta}, {OHE_config.e}, {OHE_config.a}, {OHE_config.T_0}, {OHE_config.mCp_c}, {OHE_config.mCp_r}, {OHE_config.mCp_f}, {OHE_config.alpha_c}, {OHE_config.alpha_r}, {OHE_config.alpha_f})")
    st.success("Success!!")
...
if __name__ == "__main__":
    ...
    st.markdown(
        f"""
        <a href="/OHE_tTo_options" target="_self" class="custom-button">Back</a>
        """,
        unsafe_allow_html=True
    )