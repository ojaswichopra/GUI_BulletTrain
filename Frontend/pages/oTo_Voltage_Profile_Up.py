    ...
    if st.button("Submit"):
        ...
        with open(image_path, "rb") as file:
            btn = st.download_button(
                label="Download Plot",
                data=file,
                file_name="Full_UP_track_voltage_profile_instant_t_outage.png",  # Replace with the desired download filename
                mime="image/png"
            )
