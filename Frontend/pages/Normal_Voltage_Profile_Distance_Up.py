...
def main():
    ...
    st.markdown("<h1 class='title'>Voltage Profile at a Particular Distance Up Track</h1>", unsafe_allow_html=True)
    ...
    if st.button("Submit"):
        ...
        with open(image_path, "rb") as file:
            btn = st.download_button(
                label="Download Plot",
                data=file,
                file_name="UP_line_voltage_variation_over_day.png",  # Replace with the desired download filename
                mime="image/png"
            )
