...
def main():
    ...
    with col1:
        if st.button('Voltage Profile of the track at the time instant of fault'):
            ...
            #         mime="image/png"
            #     )
            st.switch_page("pages/SCA_output_double_up_voltage.py")
    ...
    with col2:
        if st.button('Line Current Profile of the track at the time instant of fault'):
            ...
            #         mime="image/png"
            #     )
            st.switch_page("pages/SCA_output_double_up_current.py")
                
if __name__ == "__main__":
    main()
    st.markdown(
        f"""
        <a href="/SCA_output_options" target="_self" class="custom-button">Back</a>
        """,
        unsafe_allow_html=True
    )
