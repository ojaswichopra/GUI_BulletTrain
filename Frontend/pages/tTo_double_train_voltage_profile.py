    ...
    if st.button("Submit"):
        ...
        with open(image_path, "rb") as file:
            btn = st.download_button(
                label="Download Plot",
                data=file,
                file_name="train_voltage_profile_train_number_adjacent_outage_load_file.png",  # Replace with the desired download filename
                mime="image/png"
            )
