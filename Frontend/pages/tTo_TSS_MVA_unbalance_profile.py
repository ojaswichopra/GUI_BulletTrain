...
def main():
    ...
    if(st.button("Show TSS MVA profile")):
        ...
        s_apprant_power_MVA_mag = tTo_workspace['s_apprant_power_MVA_mag']
        oc.push('s_apprant_power_MVA_mag', s_apprant_power_MVA_mag)
        # Mva_sec_abs = tTo_workspace['Mva_sec_abs']
        # oc.push('Mva_sec_abs', Mva_sec_abs)
        Unb = tTo_workspace['Unb']
        oc.push('Unb', Unb)
        tt_time = tTo_workspace['tt_time']
        ...
        # )
        image_path = '../Plots_tTo/tTo_TSS_MVA_voltage_unbalance.png'
        ...
        with open(image_path, "rb") as file:
            btn = st.download_button(
                label="Download Plot",
                data=file,
                file_name="tTo_TSS_MVA_voltage_unbalance.png",  # Replace with the desired download filename
                mime="image/png"
            )
    if os.path.isfile('../two_TSS_outage/maximum_mva_and_unbalance.mat'):
