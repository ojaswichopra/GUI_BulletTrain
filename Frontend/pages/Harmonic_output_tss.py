...
def load_harmonic_workspace():
    variable_names = [
        'train_number', 'track_type', 'train_type', 'start_time', 'each_stop_train_data_up', 'rapid_train_data_up', 'each_stop_train_data_down', 'rapid_train_data_down', 'track_length', 'd', 'dTSS_up', 'dTSS_down', 'N_TSS', 'y', 'j_a', 'j_b', 'N_TSS_O'
    ]
...
def main():
    ...
    st.markdown("<h1 class='title'>Output of harmonic analysis - TSS Outage Condition</h1>", unsafe_allow_html=True)
    ...
    with col1:
        if st.button('One TSS Outage'):
            ...
            st.switch_page("pages/Harmonic_output_oTo.py")
