...
def main():
    ...
    if(st.button("Show TSS MVA and voltage unbalance profile")):
        ...
        maximum_mva, maximum_unbalance = oc.eval(f"TSS_MVA_voltage_unbalance_profile_plot_outage_load_txt({nn_track},TSS,N_TSS_O,dTSS_T,s_apprant_power_MVA_mag,Unb,tt_time)", nout=2)
