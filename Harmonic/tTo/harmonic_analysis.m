...
fileID = fopen('../Harmonic_current_spectrum.txt', 'r'); 
...
YcrfT_loaded = load("../../tTo_double_text_files/YcrfT.txt");
% Determine the number of columns
...
YcrfM_loaded = load("../../tTo_double_text_files/YcrfM.txt");
% Determine the number of columns
...
Yat_loaded = load("../../tTo_double_text_files/Yat.txt");
% Determine the number of columns
...
Zshort_loaded = load("../../tTo_double_text_files/Zshort.txt");
% Determine the number of columns
...
THD_C_T=-10*ones(N_TSS_new*y,30);   %Contact wire THD (percentage) of all Teaser windings for entire time instant of operation
THD_R_T=-10*ones(N_TSS_new*y,30);   %Rail THD (percentage) of all Teaser windings for entire time instant of operation
THD_F_T=-10*ones(N_TSS_new*y,30);   %Feeder wire THD (percentage) of all Teaser windings for entire time instant of operation
THD_C_M=-10*ones(N_TSS_new*y,30);   %Contact wire THD (percentage) of all Main windings for entire time instant of operation
THD_R_M=-10*ones(N_TSS_new*y,30);   %Rail THD (percentage) of all Main windings for entire time instant of operation
THD_F_M=-10*ones(N_TSS_new*y,30);   %Feeder wire THD (percentage) of all Main windings for entire time instant of operation
THD_C_T_up=-10*ones(N_TSS_new*y,30);%Up-track contact wire THD (percentage) of all Teaser windings for entire time instant of operation
THD_C_T_down=-10*ones(N_TSS_new*y,30);%Down-track contact wire THD (percentage) of all Teaser windings for entire time instant of operation
THD_C_M_up=-10*ones(N_TSS_new*y,30);%Up-track contact wire THD (percentage) of all Main windings for entire time instant of operation
THD_C_M_down=-10*ones(N_TSS_new*y,30);%Down-track contact wire THD (percentage) of all Main windings for entire time instant of operation
TSS_primary_THD=zeros(N_TSS_new*y,3); % TSS primary side phase A, phase B, phase C THD (%)
...
save("harmonic_analysis_variables_2_TSS_outage.mat","THD_C_T_up","THD_C_M_up","THD_C_T_down","THD_C_M_down","TSS_primary_THD") 
