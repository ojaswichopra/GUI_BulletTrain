function harmonic_analysis(dTSS_T_up, dTSS_M_up, dTSS_T_down, dTSS_M_down, pTSS_T_up, pTSS_M_up, pTSS_T_down, pTSS_M_down, tTSS_T_up, tTSS_M_up, tTSS_T_down, tTSS_M_down, Vc_mag_Td, Vc_mag_Md, Vc_ang_Td, Vc_ang_Md, VR_mag_Td, Vf_mag_Td, VR_mag_Md, Vf_mag_Md, N_TSS, y, a1, a2, Ic_line_mag_Td_up, Ic_line_ang_Td_up, If_line_mag_Td_up, If_line_ang_Td_up, Ic_line_mag_Td_down, Ic_line_ang_Td_down, If_line_mag_Td_down, If_line_ang_Td_down, Ic_line_mag_Md_up, Ic_line_ang_Md_up, If_line_mag_Md_up, If_line_ang_Md_up, Ic_line_mag_Md_down, Ic_line_ang_Md_down, If_line_mag_Md_down, If_line_ang_Md_down, Vp)
    ...
    z1_loaded = load("../../oTo_double_text_files/z1.txt");
    ...
    YcrfT_loaded = load("../../oTo_double_text_files/YcrfT.txt");
    % Determine the number of columns
    ...
    YcrfM_loaded = load("../../oTo_double_text_files/YcrfM.txt");
    % Determine the number of columns
    ...
    Yat_loaded = load("../../oTo_double_text_files/Yat.txt");
    % Determine the number of columns
    ...
    Zshort_loaded = load("../../oTo_double_text_files/Zshort.txt");
    % Determine the number of columns
    ...
    THD_C_T=-10*ones(N_TSS_new*y,15);   %Contact wire THD (percentage) of all Teaser windings for entire time instant of operation
    THD_R_T=-10*ones(N_TSS_new*y,15);   %Rail THD (percentage) of all Teaser windings for entire time instant of operation
    THD_F_T=-10*ones(N_TSS_new*y,15);   %Feeder wire THD (percentage) of all Teaser windings for entire time instant of operation
    THD_C_M=-10*ones(N_TSS_new*y,15);   %Contact wire THD (percentage) of all Main windings for entire time instant of operation
    THD_R_M=-10*ones(N_TSS_new*y,15);   %Rail THD (percentage) of all Main windings for entire time instant of operation
    THD_F_M=-10*ones(N_TSS_new*y,15);   %Feeder wire THD (percentage) of all Main windings for entire time instant of operation
    THD_C_T_up=-10*ones(N_TSS_new*y,15);%Up-track contact wire THD (percentage) of all Teaser windings for entire time instant of operation
    THD_C_T_down=-10*ones(N_TSS_new*y,15);%Down-track contact wire THD (percentage) of all Teaser windings for entire time instant of operation
    THD_C_M_up=-10*ones(N_TSS_new*y,15);%Up-track contact wire THD (percentage) of all Main windings for entire time instant of operation
    THD_C_M_down=-10*ones(N_TSS_new*y,15);%Down-track contact wire THD (percentage) of all Main windings for entire time instant of operation
    ...
    save("../Harmonic_output/oTo/harmonic_analysis_variables_1_TSS_outage.mat","THD_C_T_up","THD_C_M_up","THD_C_T_down","THD_C_M_down","TSS_primary_THD") 
