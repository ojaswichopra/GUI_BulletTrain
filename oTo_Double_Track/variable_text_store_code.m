% fileID = fopen('../oto_double_text_files/dTSS.txt', 'w');
% for row = 1:size(dTSS, 1)
%     fprintf(fileID, [repmat('%.16g ', 1, size(dTSS, 2)) '\n'], dTSS(row, :));
% end
% fclose(fileID);
% 
% fileID = fopen('../oto_double_text_files/dTSS_T.txt', 'w');
% for row = 1:size(dTSS_T, 1)
%     fprintf(fileID, [repmat('%.16g ', 1, size(dTSS_T, 2)) '\n'], dTSS_T(row, :));
% end
% fclose(fileID);
% 
% fileID = fopen('../oto_double_text_files/TSS.txt', 'w');
% for row = 1:size(TSS, 1)
%     fprintf(fileID, [repmat('%.16g ', 1, size(TSS, 2)) '\n'], TSS(row, :));
% end
% fclose(fileID);
% 
% fileID = fopen('../oto_double_text_files/d.txt', 'w');
% for row = 1:size(d, 1)
%     fprintf(fileID, [repmat('%.16g ', 1, size(d, 2)) '\n'], d(row, :));
% end
% fclose(fileID);
% 
% fileID = fopen('../oto_double_text_files/y.txt', 'w');
% for row = 1:size(y, 1)
...
% fclose(fileID);
% 
% fileID = fopen('../oto_double_text_files/VR_ang_Td.txt', 'w');
...
% fclose(fileID);
% 
% fileID = fopen('../oto_double_text_files/Vf_ang_Td.txt', 'w');
...
% fileID = fopen('../oto_double_text_files/z1.txt', 'w');
% 
...
% fclose(fileID);
% 
% fileID = fopen('../oto_double_text_files/VR_ang_Md.txt', 'w');
...
fileID = fopen('../oTo_double_text_files/dTSS_T_up.txt', 'w');
...
fileID = fopen('../oTo_double_text_files/dTSS_M_up.txt', 'w');
for row = 1:size(dTSS_M_up, 1)
    fprintf(fileID, [repmat('%.16g ', 1, size(dTSS_M_up, 2)) '\n'], dTSS_M_up(row, :));
end
fclose(fileID);
fileID = fopen('../oTo_double_text_files/dTSS_M_down.txt', 'w');
...
% fileID = fopen('../oto_double_text_files/train_data.txt', 'w');
...
fileID = fopen('../oTo_double_text_files/AT_mva_mag_down.txt', 'w');
...
fileID = fopen('../oTo_double_text_files/train_number.txt', 'w');
...
fileID = fopen('../oTo_double_text_files/track_type.txt', 'w');
...
fileID = fopen('../oTo_double_text_files/train_type.txt', 'w');
for row = 1:size(train_type, 1)
    fprintf(fileID, [repmat('%.16g ', 1, size(train_type, 2)) '\n'], train_type(row, :));
end
fclose(fileID);

fileID = fopen('../oTo_double_text_files/start_time.txt', 'w');
for row = 1:size(start_time, 1)
    fprintf(fileID, [repmat('%.16g ', 1, size(start_time, 2)) '\n'], start_time(row, :));
end
fclose(fileID);

fileID = fopen('../oTo_double_text_files/each_stop_train_data_up.txt', 'w');
...
fileID = fopen('../oTo_double_text_files/rapid_train_data_up.txt', 'w');
for row = 1:size(rapid_train_data_up, 1)
    fprintf(fileID, [repmat('%.16g ', 1, size(rapid_train_data_up, 2)) '\n'], rapid_train_data_up(row, :));
end
fclose(fileID);

fileID = fopen('../oTo_double_text_files/each_stop_train_data_down.txt', 'w');
