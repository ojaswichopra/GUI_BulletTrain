function OHE_temp_cal_down_track(Ic_line_mag_Td_down, Ir_line_mag_Td_down, If_line_mag_Td_down, Ic_line_mag_Md_down, Ir_line_mag_Md_down, If_line_mag_Md_down, y, N_TSS, d,N_TSS_O, j_a, j_b, j_c, j_d, rad_C, rad_R1, rad_F, Resistance_C, Resistance_R1, Resistance_F, Q_s, T_a, V_w, theta, e, a, T_0, mCp_c, mCp_r, mCp_f, alpha_c, alpha_r, alpha_f)
    ...
    % Ic_line_mag_Td_down=load("Ic_line_mag_Td_down.txt");   %contact wire line currents of all teaser windings in kA
    % Ir_line_mag_Td_down=load("Ir_line_mag_Td_down.txt");   %rail line currents of all teaser windings in kA
    % If_line_mag_Td_down=load("If_line_mag_Td_down.txt");   %feeder wire line currents of all teaser windings in kA
    % Ic_line_mag_Md_down=load("Ic_line_mag_Md_down.txt");   %contact wire line currents of all main windings in kA
    % Ir_line_mag_Md_down=load("Ir_line_mag_Md_down.txt");   %rail line currents of all main windings in kA
    % If_line_mag_Md_down=load("If_line_mag_Md_down.txt");   %feeder wire line currents of all main windings in kA
    ...
    save('OHE_temp_down_track_variables_2_TSS_outage.mat','d_new','y','T_c_track_down','T_r_track_down','T_f_track_down',...
    ...
    %         track_temp_f(i_f,1)=T_f_track_down((i_e-1)*y+time_instant);
    %     end
    % end
    % 
    ...
    %         hold on
    %         plot(time/60,[T_f_initial,T_f_track_down((ii-1)*y+1:ii*y)'],"Color",'b');
    %         xlabel('Time (minute)')
