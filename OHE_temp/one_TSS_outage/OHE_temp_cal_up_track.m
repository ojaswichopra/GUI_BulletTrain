function OHE_temp_cal_up_track(Ic_line_mag_Td_up, Ir_line_mag_Td_up, If_line_mag_Td_up, Ic_line_mag_Md_up, Ir_line_mag_Md_up, If_line_mag_Md_up, y, N_TSS, d, N_TSS_O, j_a, j_b, rad_C, rad_R1, rad_F, Resistance_C, Resistance_R1, Resistance_F, Q_s, T_a, V_w, theta, e, a, T_0, mCp_c, mCp_r, mCp_f, alpha_c, alpha_r, alpha_f) 
    ...
    % load('Double_track_TSS1_outage_load_flow_variables.mat', 'Ic_line_mag_Td_up')    %contact wire line currents of all teaser windings in kA
    % Ic_line_mag_Td_up=load("Ic_line_mag_Td_up.txt");
    % % load('Double_track_TSS1_outage_load_flow_variables.mat', 'Ir_line_mag_Td_up')    %rail line currents of all teaser windings in kA
    % Ir_line_mag_Td_up=load("Ir_line_mag_Td_up.txt");
    % % load('Double_track_TSS1_outage_load_flow_variables.mat', 'If_line_mag_Td_up')    %feeder wire line currents of all teaser windings in kA
    % If_line_mag_Td_up=load("If_line_mag_Td_up.txt");
    % % load('Double_track_TSS1_outage_load_flow_variables.mat', 'Ic_line_mag_Md_up')    %contact wire line currents of all main windings in kA
    % Ic_line_mag_Md_up=load("Ic_line_mag_Md_up.txt");
    % % load('Double_track_TSS1_outage_load_flow_variables.mat', 'Ir_line_mag_Md_up')    %rail line currents of all main windings in kA
    % Ir_line_mag_Md_up=load("Ir_line_mag_Md_up.txt");
    % % load('Double_track_TSS1_outage_load_flow_variables.mat', 'If_line_mag_Md_up')    %feeder wire line currents of all main windings in kA
    ...
    save('OHE_temp_up_track_variables_1_TSS_outage.mat','d_new','y','T_c_track_up','T_r_track_up','T_f_track_up',...
