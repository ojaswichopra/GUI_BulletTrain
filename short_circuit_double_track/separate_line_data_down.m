...
dTSS_T_down=zeros(no_of_TSS*y,15);
dTSS_M_down=zeros(no_of_TSS*y,15);
pTSS_T_down=zeros(no_of_TSS*y,15);
pTSS_M_down=zeros(no_of_TSS*y,15);
tTSS_T_down=zeros(no_of_TSS*y,15);
tTSS_M_down=zeros(no_of_TSS*y,15);
winding_position=0;
check=1;
x_dTss_T_down=1;
x_dTss_M_down=1;
for n_time=1:1:NT_T
    ...
    percentage_completion_down_line=(n_time/NT_T)*100   %percentage of total computation completed
end