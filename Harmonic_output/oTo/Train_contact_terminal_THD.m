function Train_contact_terminal_THD(entered_train_number, train_number, track_type, train_type, start_time, each_stop_train_data_up, rapid_train_data_up, each_stop_train_data_down, rapid_train_data_down, track_length, d, dTSS_up, dTSS_down, N_TSS, y, N_TSS_O, j_a, j_b)

    tic

    % This .mat file is generated after performing harmonic analysis under one TSS outage condition
    load("harmonic_analysis_variables_1_TSS_outage.mat","THD_C_T_up","THD_C_M_up","THD_C_T_down","THD_C_M_down")
    % load("harmonic_analysis_variables_5th_TSS_outage.mat","THD_C_T_up","THD_C_M_up","THD_C_T_down","THD_C_M_down")
    % load("harmonic_analysis_variables_11th_TSS_outage.mat","THD_C_T_up","THD_C_M_up","THD_C_T_down","THD_C_M_down")

    % load('Double_track_TSS1_outage_load_flow_variables.mat',"y","N_TSS","N_TSS_O","d","j_a","j_b","dTSS_up","dTSS_down")
    % load('Double_track_TSS5_outage_load_flow_variables.mat',"y","N_TSS","N_TSS_O","d","j_a","j_b","dTSS_up","dTSS_down")
    % load('Double_track_TSS11_outage_load_flow_variables.mat',"y","N_TSS","N_TSS_O","d","j_a","j_b","dTSS_up","dTSS_down")
    ...
    if ismember(entered_train_number, train_number)
        ...
        desired_filename = '../../Plots_harmonic/Train_contact_terminal_THD_oTo.png';
