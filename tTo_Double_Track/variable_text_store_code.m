...
fileID = fopen('../tTo_double_text_files/z1.txt', 'w');
...
fileID = fopen('../tTo_double_text_files/rapid_train_data_up.txt', 'w');
for row1 = 1:size(rapid_train_data_up, 1)
    fprintf(fileID, [repmat('%.16g ', 1, size(rapid_train_data_up, 2)) '\n'], rapid_train_data_up(row1, :));
end
fclose(fileID);

fileID = fopen('../tTo_double_text_files/each_stop_train_data_down.txt', 'w');
...
fileID = fopen('../tTo_double_text_files/rapid_train_data_down.txt', 'w');
