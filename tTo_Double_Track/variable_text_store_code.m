% fileID = fopen('../tto_double_text_files/dTSS.txt', 'w');
% for row = 1:size(dTSS, 1)
%     fprintf(fileID, [repmat('%.16g ', 1, size(dTSS, 2)) '\n'], dTSS(row, :));
% end
% fclose(fileID);
% 
% fileID = fopen('../tto_double_text_files/dTSS_T.txt', 'w');
...
% fclose(fileID);
% 
% fileID = fopen('../tto_double_text_files/VR_ang_Td.txt', 'w');
...
% fclose(fileID);
% 
% fileID = fopen('../tto_double_text_files/Vf_ang_Td.txt', 'w');
...
% fclose(fileID);
% 
% fileID = fopen('../tto_double_text_files/VR_ang_Md.txt', 'w');
...
% fileID = fopen('../tto_double_text_files/train_data.txt', 'w');
