...
dTSS_T=zeros(no_of_TSS*y,20);
dTSS_M=zeros(no_of_TSS*y,20);
pTSS_T=zeros(no_of_TSS*y,20);
pTSS_M=zeros(no_of_TSS*y,20);
tTSS_T=zeros(no_of_TSS*y,20);
tTSS_M=zeros(no_of_TSS*y,20);
winding_position=0;
check=1;
x_dTss_T=1;
x_dTss_M=1;
