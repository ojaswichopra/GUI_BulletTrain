function code_run_adjecent_outage_gnu(N_TSS_O_str, TSS, AT, SP, Vp, Vs, Rp, Xp, Rs, Xs, Zn, short_ckt_MVA, lresistance, lreactance, mresistance, mreactance, row, f, n1, Ch, Mh, nFh, nFd, gh, gd, contact_wire_diameter, Resistance_C, messenger_wire_diameter, Resistance_M1, earth_wire_diameter, Resistance_G, feeder_wire_diameter, Resistance_F, rail_diameter, Resistance_R1)
    ...
    separate_line_data_adjecent_outage_up;
    separate_line_data_adjecent_outage_down;
