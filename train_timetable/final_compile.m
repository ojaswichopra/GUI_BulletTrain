function final_compile(number_of_sections)
    ...
    % all_stop = Mumbai_Thane;
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);

    % s2 = size(Thane_Virar,1);
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Thane_Virar(kk,1);
    %     all_stop(s1+kk-1,2:6) = Thane_Virar(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Virar_Boisar(kk,1);
    %     all_stop(s1+kk-1,2:6) = Virar_Boisar(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Boisar_Vapi(kk,1);
    %     all_stop(s1+kk-1,2:6) = Boisar_Vapi(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Vapi_Bilimora(kk,1);
    %     all_stop(s1+kk-1,2:6) = Vapi_Bilimora(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Bilimora_Surat(kk,1);
    %     all_stop(s1+kk-1,2:6) = Bilimora_Surat(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Surat_Bharuch(kk,1);
    %     all_stop(s1+kk-1,2:6) = Surat_Bharuch(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Bharuch_Vadodara(kk,1);
    %     all_stop(s1+kk-1,2:6) = Bharuch_Vadodara(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Vadodara_Anand(kk,1);
    %     all_stop(s1+kk-1,2:6) = Vadodara_Anand(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Anand_Ahmedabad(kk,1);
    %     all_stop(s1+kk-1,2:6) = Anand_Ahmedabad(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
    ...
    % for kk = 2:s2
    %     all_stop(s1+kk-1,1) = x1 + Ahmedabad_Sabarmati(kk,1);
    %     all_stop(s1+kk-1,2:6) = Ahmedabad_Sabarmati(kk,2:6);
    % end
    % s1 = size(all_stop,1);
    % x1 = all_stop(s1,1);
